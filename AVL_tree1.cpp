...
class avl{
    ...
    void right_left_rotate(node*);
    void left_right_rotate(node*);
    void create();
    node* search(int);
    void inorder();
    node* minimum(node*);
...
void avl :: insert(node* n){
    ...
    while(t1 && (abs(t1->l_height - t1->r_height)<2)){
        t3 = t2;
        t2 = t1;
        t1 = t1->parent;
    }
    if(t1 == NULL){
        ...
        if(t2 == t1->left && t3 == t2->left){
            ...
            left_right_rotate(t1);
        }
        else if(t2 == t1->right && t3 == t2->left){
            right_left_rotate(t1);
        }
    }
    return ;
}

void avl :: leftrotate(node* n1){
    node* n2 = n1->right;
    node* n3 = n2->right;
    node* n4 = n1->parent;
    node* n5 = n2->left;
...
void avl :: left_right_rotate(node* n1){
    node* n2 = n1->left;
    node* n3 = n2->right;
    node* n4 = n1->parent;
    node* n5 = n3->left;
...
void avl :: right_left_rotate(node* n1){
    node* n2 = n1->right;
    node* n3 = n2->left;
    node* n4 = n1->parent;
    node* n5 = n3->left;
